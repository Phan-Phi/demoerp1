...
type DiscountedCategoryDialogColumnProps = CommonTableProps<any> & Record<string, any>;

const DiscountedCategoryDialogColumn = (props: DiscountedCategoryDialogColumnProps) => {
  const {
    getTable,
    data,
    count,
...
export default DiscountedCategoryDialogColumn;
