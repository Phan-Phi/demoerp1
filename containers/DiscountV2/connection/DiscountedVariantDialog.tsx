...
import DiscountedVariantDialogColumn from "../columns/DiscountedVariantDialogColumn";
import { PRODUCT_VARIANT } from "apis";
...
export default function DiscountedVariantDialog(props: AddUsedByUserProps) {
  ...
  const {
    ...
    isLoading,
    refreshData,
  } = useFetch<any>(transformUrl(ADMIN_PRODUCTS_VARIANTS_END_POINT, { ...filter }));
