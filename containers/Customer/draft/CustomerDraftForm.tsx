...
import { ADMIN_CUSTOMERS_DRAFTS_WITH_ID_PATCH_YUP_SCHEMA_TYPE } from "__generated__/PATCH_YUP";

type CustomerDraftFormProps = {
  watch: any;
  control: any;
  setError: any;
  clearErrors: any;
...
export default function CustomerDraftForm(props: CustomerDraftFormProps) {
  ...
  const control =
    props.control as Control<ADMIN_CUSTOMERS_DRAFTS_WITH_ID_PATCH_YUP_SCHEMA_TYPE>;
  const watch =
    props.watch as UseFormWatch<ADMIN_CUSTOMERS_DRAFTS_WITH_ID_PATCH_YUP_SCHEMA_TYPE>;
  const setError =
    props.setError as UseFormSetError<ADMIN_CUSTOMERS_DRAFTS_WITH_ID_PATCH_YUP_SCHEMA_TYPE>;

  const clearErrors =
    props.clearErrors as UseFormClearErrors<ADMIN_CUSTOMERS_DRAFTS_WITH_ID_PATCH_YUP_SCHEMA_TYPE>;
