...
import ColumnPrint from "../CustomerReport/print/ColumnPrint";
...
import ColumDetailPrint from "../StaffReport/ColumDetailPrint";
...
export default function CustomerReportDetailPrint(props: any) {
  const {
    _viewType,
    onPageChange,
    onPageSizeChange,
